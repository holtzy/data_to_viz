...
Instead of presenting this graphic to your audience, you probably want to highlight what your point is. Let's say that you're specifically interested by the evolution of Amanda. Then it makes more sense to build something like that:
```{r, warning=FALSE, message=FALSE, fig.align="center", fig.width=10}
data %>%
...
- histogram are interesting because of the annotation. Note that the color is consistent between graphics.
- the value of the gaps at the start and end of the line is written so that the reader doesn't have to do the math in their head.
