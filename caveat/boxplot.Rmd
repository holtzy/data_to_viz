...
***
If you have a large sample size, using `jitter` is not an option anymore since dots will overlap, making the figure uninterpretable. A alternative is the [violin plot](https://www_data-to-viz.com/violin.html), which describes the distribution of the data for each group:
