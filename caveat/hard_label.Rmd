...
#The issue
***
Most of the time, [barplot](https://www.data_to_viz.com/graph/barplot.html) or [lollipop](https://www.data_to_viz.com/graph/lollipop.html) plot are plotted vertically: the Y axis represents the value of the numeric variable. If you label on the X axis are long, they need to be `rotated` in order not to overlap.
<br>
