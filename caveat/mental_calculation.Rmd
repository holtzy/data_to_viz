...
#Example
***
Let's consider the number of people entering (red curve) and leaving (blue curve) a shop from 8 am to 10pm. This is an accurate representation using a [line plot](https://www.data-to-viz.com/graph/line.html), that answers very well the question how many people are entering / leaving the shop.
...
#Mental arithmetic
***
To answer this question, your audience must think hard and will probably be confused.

- Is it where the marker `A` is, when the number of people entering the shop start decreasing? 
...
Of course, if more people leave the shop than the number entering, the total quantity start decreasing (marker B). But if you want your audience to focus on your point, do not give them extra work.
