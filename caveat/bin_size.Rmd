...
<br><br>
However, this bin size choice can have a strong impact on the chart insight. Let's have a look at the distribution of [Airbnb night prices on the French Riviera](http://www.data-to-viz.com/story/OneNum.html):
...
There is a huge difference difference between these two histograms. Actually a few values are over-represented in the dataset (like 58, 64, 69, 75, 80..). This is definitely a signal that you want to understand when analyzing your dataset.
