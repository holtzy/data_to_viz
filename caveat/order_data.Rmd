...
***
Let's start with a [lollipop plot]() showing the [quantity of weapons sold](https://www.data-to-viz.com/story/7_OneNumOneCat.html) by a few countries. Here each row represents a country and the X-axis shows how many weapons have been sold in 2017. Countries are ordered in alphabetical order by default.
