...
Here is a good example that takes a cluttered graphic from [viz.wtf](http://viz.wtf) and get rid of the unnecessary elements one by one. This examples comes from the website [Storytelling with data](http://www.storytellingwithdata.com/blog/2017/3/29/declutter-this-graph) by [Cole Nussbaumer Knaflic](http://www.storytellingwithdata.com/about/).  
