...
*Note*: this plot is made using the circlize library, and very strongly inspired from the [Migest package](https://github.com/cran/migest) from [Gui J. Abel](http://guyabel.com). Read more about this story [here](file:///Users/yan/Dropbox/data_to_viz/story/AdjacencyMatrix.html). 
