---
myimage: "../img/section/violinSmall.png"
mydisqus: "violin"
mytitle: "Violin plot"
output:
  html_document:
...
Violins are particularly adapted when the amount of data is huge and showing individual observations gets impossible. For small datasets, a [boxplot with jitter](http://www.data-to-viz.com/caveat/boxplot.html/#boxplotjitter) is probably a better option since it really shows all the information. This technique getting impossible with many data points, violin plot take all their sense
...
- Violin plot are made vertically most of the time. If you have long label, building an horizontal version like above make the labels more readable.

- It is possible to display a boxplot in the violin: it allows to assess the median and quartiles in a glimpse. See the boxplot section for more info.
...
- If you have just a few groups, you are probably interested by [ridgeline charts](http://www.data-to-viz.com/graph/ridgeline.html). Here is a version of the probability perception story:
