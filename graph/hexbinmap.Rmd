...
*Note on the second map*: This map shows the geographic position of about 200k tweets containing the hashtags `#surf`, `#windsurf` or `#kitesurf`. Read more about it [here](https://www.data-to-viz.com/data-to-viz/story/GPSCoordWithoutValue.html).
