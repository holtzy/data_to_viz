...
*Note*: Boundaries of city districts come from [here](https://github.com/gregoiredavid/france-geojson). Number of restaurant per district comes from [here](https://www.insee.fr/fr/statistiques/2410933).
